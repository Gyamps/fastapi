...
def test_unauthorized_user_create_all_posts(client, test_posts):
    res = client.post(
        "/posts/", json={"title": "arbitrary title", "content": "content"})
...
def test_delete_post_non_exist(authorized_client, test_posts, test_user):
    res = authorized_client.delete(f"/posts/888000")
...
def test_update_post_non_exist(authorized_client, test_posts, test_user):
    ...
    res = authorized_client.put(f"/posts/888000", json=data)
